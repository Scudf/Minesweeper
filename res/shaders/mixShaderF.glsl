...
void main()
{
    ...
    vec3 diffuse = u_light.diffuse * diff * mix(vec3(texture(u_material.diffuseTex, v_texCoord)), vec3(texture(u_material.specularTex, v_texCoord)), u_mixCoeff * u_mixCoeff);
